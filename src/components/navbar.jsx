...
import logo from "../assets/photos/ntlogo.svg"
...
export default function NavBar() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    <a className="flex title-font font-medium items-center text-white mb-4 md:mb-0">
      <img src={logo} alt="" />
      {/* <svg  fill="none" stroke="currentColor"   className="w-10 h-10 text-white p-2 bg-yellow-500 rounded-full" viewBox="0 0 24 24">
      ...
      <span className="ml-3 text-xl">The Stark Tech</span>
    </a>
    <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-yellow-500	flex flex-wrap items-center text-base justify-center">
      <a className="mr-5 hover:text-yellow-500">Home</a>
      <a className="mr-5 hover:text-yellow-500">About</a>
      <a className="mr-5 hover:text-yellow-500">Services</a>
      <a className="mr-5 hover:text-yellow-500">Contact</a>
    </nav>
    <button className="inline-flex items-center bg-gray-800 border-0 py-1 px-3 focus:outline-none hover:bg-yellow-500 rounded text-white mt-4 md:mt-0">Hire Us!
